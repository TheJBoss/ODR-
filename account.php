        ...
        <div class="account_container">
            ...
            <div class="rinks">
                ...
                <table class="table" border="1px">
                    ...
                    <th>Distance</th>
                    <tr>
                        <td><a href=#>Public Rink 4</a></td>
                        <td>1 Km away</td>
                    </tr>
                    <tr>
                        <td><a href=#>Public Rink 6</a></td>
                        <td>4 Km away</td>
                    </tr>
                </table>
            </div>
            ...
            <div class="listings">
                ...
                <h3>
                    <?php echo $_SESSION['username']; ?>'s Marketplace listings</h4>
                    <table class="table" border="1px">
                        <th>Item</th>
                        <th>Price</th>
                        <tr>
                            <td><a href=#>Item for sale</a></td>
                            <td>$1</td>
                        </tr>
            ...
            <div class="connections">
                <h3>
                    <?php echo $_SESSION['username']; ?>'s Connections
                    <table class="table" border="1px">
                        <th>Connections</th>
                        <th>Friends</th>
                        <th>Teammates</th>
                        <tr>
                            <td><a href=#>Person A</a></td>
                            <td><a href=#>Person B</a></td>
                            <td><a href=#>Person B</a></td>
                        </tr>
                        <tr>
                            <td><a href=#>Person B</a></td>
                            <td><a href=#>Person C</a></td>
                            <td><a href=#>Person D</a></td>
                        </tr>
                    </table>
            </div>
        </div>
                ...
                <div class="content">
                    ...
                    <form action="signup_action.php" method="post">
                        ...
                        <div class="inputs">
                            ...
                            <input type="password" class="user_inputs" placeholder="Confirm Password" name="passConfirm"
                                required><br>
                        </div>
